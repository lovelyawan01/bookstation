				...
				<div class="mega-dropdown-wrapper">
					...
					<div class="navigation">
						<ul>
							...
							<li class="{{ Request::is('about') ? 'active' : '' }}"><a href="/about"><i class="fa fa-files-o"></i>About</a></li>
							<li class="{{ Request::is('gallery') ? 'active' : '' }}"><a href="/gallery"><i class="fa fa-files-o"></i>gallery</a></li>
							<li class="{{ Request::is('blog') ? 'active' : '' }}"><a href="/blog"><i class="fa fa-files-o"></i>blog</a></li>
							<li class="{{ Request::is('author') ? 'active' : '' }}"><a href="/author"><i class="fa fa-file-text"></i>author</a></li>
							<li class="{{ Request::is('contact') ? 'active' : '' }}"><a href="/contact"><i class="fa fa-fax"></i>contact</a></li>
						</ul>
					</div>				
					<!-- Navigation -->
				</div>
